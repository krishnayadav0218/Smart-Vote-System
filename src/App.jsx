...
// Remaining stub — intentionally NOT a per-voter searchable registry;
    ...
    <div className="flex min-h-screen bg-[#060d1f]">
      ...
      <main className="flex-1 overflow-y-auto">
        <Routes>
          ...
          <Route path="/blockchain" element={<ProtectedRoute page="blockchain"><BlockchainPage/></ProtectedRoute>}/>
          ...
          <Route path="/audit"      element={<ProtectedRoute page="audit"><AuditLogPage/></ProtectedRoute>}/>
