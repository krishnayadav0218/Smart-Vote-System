...
export default function ReportsPage() {
  ...
  useEffect(() => {
    axios.get(`${API}/api/settings/public`).then(({ data }) => setCertified(data.finalized)).catch(() => setCertified(null));
  }, []);
  ...
  return (
    <div className="p-6">
      ...
      {certified === true && (
        <div className="mb-4 bg-purple-500/10 border border-purple-500/30 rounded-lg px-3 py-2 text-xs text-purple-300 inline-block">
          🔒 Results certified — election finalized, these numbers are final.
        </div>
      )}
